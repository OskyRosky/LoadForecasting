...
setwd("C:/Users/oscar/Desktop/GitHub/Enchanted Rock/US 2121/TestForecast15minR")

########################
# 2. Import data       #
########################

df_15min <- read_excel("df_15min_Test.xlsx", sheet = "General") 
...
df_15min <- df_15min %>%
  filter(Date <= ymd_hms("2022-01-01 00:00:00"))
